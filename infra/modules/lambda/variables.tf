...
variable "bucket_arn" {
  description = "ARN of the S3 bucket, used to scope the Lambda IAM policy."
  type        = string
}
...
variable "table_arn" {
  description = "ARN of the DynamoDB jobs table, used to scope the Lambda IAM policy."
  type        = string
}
...
variable "sites_table_arn" {
  description = "ARN of the DynamoDB sites table, used to scope the Lambda IAM policy."
  type        = string
}
